...
router.on('route:videoView', function(id) {
	...
	$('#iframe-placeholder').html('<iframe class="center" width="1120" height="630" src="http://www.youtube.com/embed/ZKs0OZM0M9k?rel=0&vq=hd720&autoplay=1" frameborder="0"></iframe>');
